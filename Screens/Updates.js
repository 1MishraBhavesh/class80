    ...
    renderItem = ({ item }) => {
        ...
        if (item.type == "Article") {
            ...
            return (
                ...
                >
                    <Text style={[styles.cardTitle,{color:"pink",fontStyle:"italic"}]}>{item.title}</Text>
    ...
    addFlag = (arr, value) => {
        for (let i = 0; i < arr.length; i++) {
          console.log("bhawesh")
            ...
            //here  in this array we have added  the type that's y it is coming for article and report
        }
        return arr
    }
